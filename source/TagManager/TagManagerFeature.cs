...
internal class TagManagerFeature
{
    internal static readonly TagManagerFeature Shared = new();
    internal static TagManagerSettings Settings => Control.MainSettings.TagManager;
    private TagManagerSettings.TagsFilterSet _currentSkirmishFilter = Settings.SkirmishDefault;
    ...
    {
        if (!isDebugLab && def.ComponentTags.Contains(MechValidationRules.ComponentTag_Debug))
        {
            return false;
        }
